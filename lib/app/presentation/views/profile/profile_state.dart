...
import 'models/profile_popup_action.dart';
...
class ProfileState extends WidgetState<YoAppScope, ProfileScope, ProfileModel, void, void> {
  ...
  Widget _buildUnsizedAvatar() =>
      model.profile.avatarFile != null
          ? ClipRRect(borderRadius: BorderRadius.circular(30), child: Image.file(model.profile.avatarFile))

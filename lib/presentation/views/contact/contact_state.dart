...
import 'package:yo_app/presentation/views/contact/contact_scope.dart';
...
class ContactState extends WidgetState<YoAppScope, ContactScope, ContactModel, Contact, void> {
  ...
  Widget _buildUnsizedAvatar() =>
      model.arg.avatar != null
          ? ClipRRect(borderRadius: BorderRadius.circular(30), child: Image.file(model.arg.avatar.file))
